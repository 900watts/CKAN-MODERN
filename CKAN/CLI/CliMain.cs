...
namespace CKAN.Modern.CLI;

/// <summary>
/// CLI entry point for CKAN-Modern — AI-powered REPL for KSP mod management.
/// Called from App.xaml.cs when running in CLI mode ("cli" arg or renamed exe).
/// </summary>
public static class CliMain
{
    ...
    {
        ConsoleRenderer.PrintSuccess("CKAN-CLI Commands");

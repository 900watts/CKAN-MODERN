...
public sealed class UpdateChecker : IDisposable
{
    ...
    private const string CURRENT_BUILD = "build-22";  // tag of the current release
    ...
    /// <summary>
    /// Compare build tags like "build-21" and "build-22".
    ...
    private static bool IsNewerBuild(string remoteTag, string currentTag)
    {
        ...
        // Extract numeric suffix from "build-NN" tags
        ...
        // If we can parse both, only update if remote is strictly greater
